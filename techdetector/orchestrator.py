...
class Orchestrator:
    ...
    def enqueue(self, domains: List[str], force: bool = False, skip_recent_hours: int = 24):
        """
        ...
        for domain in domains:
            ...
            if not force:
                ...
                if last_crawled:
                    crawled_at = datetime.fromtimestamp(last_crawled)
    ...
    def get_queue_stats(self) -> dict:
        ...
        try:
            ...
            pending_messages = sum(g.get('pending', 0) for g in consumer_groups)
